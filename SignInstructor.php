...
<html lang="en">
  <head>
    <title>Sign-up for instructor</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
include './conn.php';
        ...
        if(isset($_POST['send'])){
          ...
          if(isset($_POST['name']) && isset($_POST['mail']) && isset($_POST['phone']) ){
              ...
              $name = $_POST['name'];  $mail = $_POST['mail'];  $phone = $_POST['phone'];  $age = $_POST['age'];  $address = $_POST['address'];  $Experience = $_POST['exp'];  $pass = $_POST['pass']; $Job = $_POST['Job']; $title = $_POST['title'];

              $Img = $_FILES['image']['name'];
              $temp_img_name = $_FILES['image']['name'];
              ...
              $query = $conn->prepare("INSERT INTO instructor(name,age,phone,address,email,Num_Experience,image,Resume,skills_id,programming_fields_id,faculty_id,Position_OR_Job,title,password) VALUES('$name','$age','$phone','$address','$mail','$Experience','$Img','$Resume_name','$SKILLS',$program,$faculty,'$Job','$title','$pass')");
...
?>
      ...
      <main class=" container-fluid allCheckBody2 col-md-12">
        ...
        <div class="row g-5">
          ...
          <div class="col-md-10">
            <form class="" method="POST" enctype="multipart/form-data">
              <h1 class="h3 mb-3 fw-normal">Please sign up As an Insrtuctor</h1>
              ...
              <div class="form-floating input_sign">
                <input type="text" class="form-control input" id="floatingJob" placeholder="Your job" name="Job" required>
                <label for="floatingJob"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Your job</label>
              </div>
              ...
              <div class="form-floating input_sign">
                 <textarea  type="number" class="form-control input" id="floatingCareer" placeholder="About your career" name="title"></textarea>

                <label for="floatingCareer"><i class="fa fa-briefcase" aria-hidden="true"></i> Your career </label>
              </div>
              ...
              <div class="form-floating input_sign">
                <input  type="password" class="form-control input" id="floatingPass" placeholder="Enter Your Password" name="pass" required>
