...
<span id="result"></span>
  <form class="main" method="POST" id="form">
    <h1 class="h3 mb-10 fw-normal">Please sign in  As An Student</h1>
<br>
    ...
    <p>New to Markit? <a href="./SignStudent.php" class="A" >Sign-Up</a></p>
...
<?php
  ...
  if(isset($_POST["login"])){
    ...
    $select = $conn->prepare("SELECT * FROM  student    WHERE email = :mail AND password = :pass");
