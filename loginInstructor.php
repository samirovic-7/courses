...
<span id="result"></span>
  <form class="main" method="POST" id="form">
    <h1 class="h3 mb-10 fw-normal">Please sign in  As An Instructor</h1>
<br>
    ...
    <p>New to Markit? <a href="./SignInstructor.php" class="A" >Sign-Up</a></p>
    <p>Log-in As Student? <a href="./loginStudent.php" class="A" >Go To Log in</a></p>
    <p>Log-in As Admin? <a href="./loginAdmin.php" class="A" >Go To Log in</a></p>
  </div>
  </form>
</main>
...
<?php
  ...
  if(isset($_POST["login"])){
    ...
    $select = $conn->prepare("SELECT * FROM  instructor    WHERE email = :mail AND password = :pass");
