    ...
    <div>
        <input type="hidden" id="edit_id" value="<?php echo $Edits['id']; ?>">
          ...
          <div class="mb-3" style="text-align:left">
            ...
            <input type="text" class="form-control" id="edit_name" value="<?php echo $Edits['username']; ?>">
          </div>
          <div class="mb-3" style="text-align:left">
          ...
          <div class="mb-3" style="text-align:left">
            ...
            <input type="number" class="form-control" id="edit_Exp"  value="<?php echo $Edits['Num_Experience']; ?>">
          </div>
