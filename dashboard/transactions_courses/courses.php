  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">form addition</h5>
      ...
      <form action="" method="POST" id="form"  enctype="multipart/form-data">
          <div id="result"></div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label"  style="float:left;">:Vedio Name</label>
            <input type="text" class="form-control" id="name" name="name">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label"  style="float:left;">:Upload Poster of this Vedio</label>
            <input type="file" class="form-control" id="inputGroupFile02" name="phone" id="phone">

          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label"  style="float:left;">:Upload vedio</label>
             
            <input type="file" class="form-control" id="inputGroupFile02"  name="address" id="address">
          ...
          <label for="recipient-name" class="col-form-label"  style="float:left;">:Field Of This Courses</label>
          ...
          <div class="form-floating input_sign" style="display:flex; flex-wrap:wrap; justify-content:space-around;">
              ...
              <option value="Field" hidden >courses</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="add" name="add">save </button>
      </div>
      </form>   
      </div>
    </div>
