...
public function insert(){
    if(isset($_POST['add'])){
        if(isset($_POST['name'])){
            ...
            $query = "INSERT INTO skills(skills) VALUES('$name')";
    ...
    public function del($del_id){
        ...
        $delete = $this->conn->prepare("DELETE FROM  skills WHERE   id = '$del_id' ;  ");
    ...
    public function edit($edit_id){
        ...
        // return $edit;
         ...
         $data = null;
         $edit = $this->conn->prepare("SELECT * FROM skills WHERE id =  '$edit_id'");
        $edit -> execute();
        $data = $edit ->fetchAll();
        return $data;
    }
    ...
    public function update($data){
        ...
        $update = $this->conn->prepare("UPDATE skills SET  skills = '$data[edit_name]'   WHERE id =  '$data[edit_id]'");
