...
public function insert(){
    if(isset($_POST['add'])){
        if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['age']) && isset($_POST['email']) && isset($_POST['address']) && isset($_POST['experiance']) && isset($_POST['pass'])){
            ...
            $name = $_POST['name'];  $phone = $_POST['phone'];  $age = $_POST['age'];    $email = $_POST['email']; $address = $_POST['address'];  $experiance = $_POST['experiance']; $pass = $_POST['pass'];

            $query = "INSERT INTO student(name,phone,age,email,address,Experience,password) VALUES('$name','$phone','$age','$email','$address','$experiance','$pass')";
    ...
    public function fetch(){
        ...
        $select = $this->conn->prepare("SELECT * FROM student");
    ...
    public function del($del_id){
        ...
        $delete = $this->conn->prepare("DELETE FROM  student WHERE   id = '$del_id' ;  ");
    ...
    public function edit($edit_id){
        ...
        // return $edit;
         ...
         $data = null;
         $edit = $this->conn->prepare("SELECT * FROM student WHERE id =  '$edit_id'");
        $edit -> execute();
        $data = $edit ->fetchAll();
        return $data;
    }
    ...
    public function update($data){
        ...
        $update = $this->conn->prepare("UPDATE student SET  name = '$data[edit_name]', phone = '$data[edit_phone]',  address = '$data[edit_address]', age = '$data[edit_age]' WHERE id =  '$data[edit_id]'");
