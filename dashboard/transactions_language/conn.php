...
public function insert(){
    if(isset($_POST['add'])){
        if(isset($_POST['name'])){
            ...
            $query = "INSERT INTO programming_fields(langs) VALUES('$name')";
    ...
    public function del($del_id){
        ...
        $delete = $this->conn->prepare("DELETE FROM  programming_fields WHERE   id = '$del_id' ;  ");
    ...
    public function edit($edit_id){
        ...
        // return $edit;
         ...
         $data = null;
         $edit = $this->conn->prepare("SELECT * FROM programming_fields WHERE id =  '$edit_id'");
        $edit -> execute();
        $data = $edit ->fetchAll();
        return $data;
    }
    ...
    public function update($data){
        ...
        $update = $this->conn->prepare("UPDATE programming_fields SET  langs = '$data[edit_name]'   WHERE id =  '$data[edit_id]'");
