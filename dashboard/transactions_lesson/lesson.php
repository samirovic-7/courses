  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="" method="POST" id="form">
          <div id="result"></div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label"  style="float:left;">:title this Courses</label>
            <input type="text" class="form-control" id="name">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label"  style="float:left;">:About Your Courses</label>
            <input type="text" class="form-control" id="phone">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label"  style="float:left;">:States</label>
             
            <select class="select"  name="address" id="address">

              <option value="States" hidden >states</option>
          ...
          <div class="form-floating input_sign" style="display:flex; flex-wrap:wrap; justify-content:space-around;">
              ...
              <option value="Field" hidden >Field</option>
