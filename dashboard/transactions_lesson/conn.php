...
public function insert(){
    if(isset($_POST['add'])){
        if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['address']) && isset($_POST['age'])){
            ...
            $query = "INSERT INTO courses_card(title,about,state,skills_id) VALUES('$name','$phone','$address','$age')";
    ...
    public function update($data){
        ...
        $update = $this->conn->prepare("UPDATE courses_card SET  title = '$data[edit_name]', about = '$data[edit_phone]',    state = '$data[edit_age]'   WHERE id =  '$data[edit_id]'");
