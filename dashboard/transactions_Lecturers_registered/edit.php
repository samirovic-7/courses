...
<form action="" method="POST" id="form">
    ...
    <div>
        <input type="hidden" id="edit_id" value="<?php echo $Edits['id']; ?>">
          ...
          <div class="mb-3" style="text-align:left">
            <label for="recipient-name" class="col-form-label"><h5>numLesson</h5></label>
            <input type="text" class="form-control" id="edit_address"  value="<?php echo $Edits['numLesson']; ?>">
          </div>
          <div class="mb-3" style="text-align:left">
            <label for="recipient-name" class="col-form-label"><h5>state</h5></label>
            <input type="text" class="form-control" id="edit_age"  value="<?php echo $Edits['state']; ?>">
          </div>
